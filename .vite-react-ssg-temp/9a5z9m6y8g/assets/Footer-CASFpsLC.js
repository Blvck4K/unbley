import { n as motion } from "./PageTransition-8IvNPEDC.js";
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: user ? /* @__PURE__ */ jsxs(Fragment$1, { children: [/* @__PURE__ */ jsx(Link, {
							to: "/dashboard",
			...
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: user ? /* @__PURE__ */ jsxs(Fragment$1, { children: [/* @__PURE__ */ jsxs(Link, {
							to: "/dashboard",
							onClick: () => setIsMenuOpen(false),
							...
							children: "Logout"
						})] }) : /* @__PURE__ */ jsxs(Fragment$1, { children: [/* @__PURE__ */ jsxs(Link, {
							to: "/auth?mode=signin",
							onClick: () => setIsMenuOpen(false),
							className: "font-semibold flex items-center gap-3",
							style: {
