import { n as supabase } from "./assets/supabase-DvwDzIWb.js";
import { n as AuthProvider, t as useAuth } from "./assets/useAuth-BrrkS1Z-.js";
import { t as createLucideIcon } from "./assets/createLucideIcon-D9kzrCV5.js";
import { t as MessageCircle } from "./assets/message-circle-mj3Lnc5B.js";
import { t as Minus } from "./assets/minus-DJMBSzTI.js";
import { t as Send } from "./assets/send-C9BFhCcX.js";
import { t as X } from "./assets/x-C906TXTk.js";
...
//#endregion
//#region src/App.jsx
var Home = lazy(() => import("./assets/Home-CMgSrQal.js"));
var Auth = lazy(() => import("./assets/Auth-B33nr7Dp.js"));
var Dashboard = lazy(() => import("./assets/Dashboard-D9UOb18L.js"));
var Profile = lazy(() => import("./assets/Profile-Ddmh2PXZ.js"));
var Edit = lazy(() => import("./assets/Edit-KPv-ChoM.js"));
var Activation = lazy(() => import("./assets/Activation-CAufky04.js"));
var Storefront = lazy(() => import("./assets/Storefront-r6LFMmn-.js"));
var ExploreBrand = lazy(() => import("./assets/ExploreBrand-D-opcdQC.js"));
var FinalizeActivation = lazy(() => import("./assets/FinalizeActivation-jSeaopO3.js"));
var SuccessPage = lazy(() => import("./assets/SuccessPage-3HRvBpMA.js"));
var CheckoutSuccess = lazy(() => import("./assets/CheckoutSuccess-CP-GNaOJ.js"));
var ShopBrand = lazy(() => import("./assets/ShopBrand-BdKMP3Dc.js"));
var Cart = lazy(() => import("./assets/Cart-n0ndelNX.js"));
var Checkout = lazy(() => import("./assets/Checkout-BUFNJdAQ.js"));
var ProductDetail = lazy(() => import("./assets/ProductDetail-uG5Hc_e0.js"));
var SellDigitalGoods = lazy(() => import("./assets/SellDigitalGoods-CaAK6o91.js"));
var CreatorPlatform = lazy(() => import("./assets/CreatorPlatform-ZXVuPQrg.js"));
var CreateOnlineStore = lazy(() => import("./assets/CreateOnlineStore-CmNrYbC0.js"));
var ShopifyAlternative = lazy(() => import("./assets/ShopifyAlternative-DfOSWq_P.js"));
var AffordableEcommerce = lazy(() => import("./assets/AffordableEcommerce-CGY6f77s.js"));
var AllBlog = lazy(() => import("./assets/AllBlog-czwJlLa8.js"));
var Blog = lazy(() => import("./assets/Blog-C4P2oCL-.js"));
var AdminBlog = lazy(() => import("./assets/AdminBlog-C9BHHT7K.js"));
var FillBlog = lazy(() => import("./assets/FillBlog-wWK-HtRn.js"));
var PageLoader = () => /* @__PURE__ */ jsxs("div", {
	...
	}), /* @__PURE__ */ jsx("style", { children: `.loader-dots { display: flex; gap: 8px; } .dot { width: 12px; height: 12px; background-color: var(--primary); border-radius: 50%; animation: pulse 1.5s infinite ease-in-out; } .dot:nth-child(2) { animation-delay: 0.2s; } .dot:nth-child(3) { animation-delay: 0.4s; } @keyframes pulse { 0%, 80%, 100% { transform: scale(0); opacity: 0.3; } 40% { transform: scale(1); opacity: 1; } }` })]
});
var Layout = () => /* @__PURE__ */ jsxs(AuthProvider, { children: [/* @__PURE__ */ jsx(Suspense, {
	fallback: /* @__PURE__ */ jsx(PageLoader, {}),
	children: /* @__PURE__ */ jsx(ErrorBoundary, { children: /* @__PURE__ */ jsx(Outlet, {}) })
...
var createRoot = ViteReactSSG({ routes: [{
	...
	children: [
		...
		{
			path: "/edit",
			element: /* @__PURE__ */ jsx(ProtectedRoute, { children: /* @__PURE__ */ jsx(Edit, {}) })
		},
		{
			path: "/activation",
