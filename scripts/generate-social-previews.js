...
function injectMeta(folderPath, template, data) {
  ...
  const replacements = [
    ...
    { regex: /<meta property="og:image:width" content=".*?"\s*\/?>/, replacement: `<meta property="og:image:width" content="1200" />` },
    { regex: /<meta property="og:image:height" content=".*?"\s*\/?>/, replacement: `<meta property="og:image:height" content="630" />` },
