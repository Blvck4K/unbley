...
export default function CreatorPlatform() {
  ...
  return (
    <PageTransition>
      <Helmet>
        <title>Ecommerce for Creators & Creative Brands | ZizzyStores</title>
        <meta name="description" content="Build a professional storefront for your creative brand. The most trusted platform for artisans, designers, and creative entrepreneurs to grow their business." />
        <meta name="keywords" content="ecommerce for creators, creative brand platform, launch online store, artist shop platform, boutique ecommerce builder" />
      </Helmet>
