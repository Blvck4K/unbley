...
export default function CreateOnlineStore() {
  ...
  return (
    <PageTransition>
      <Helmet>
        <title>Create Online Store | Start Your Ecommerce Business in 5 Minutes | ZizzyStores</title>
        <meta name="description" content="The easiest way to create an online store in Nigeria and beyond. Launch your boutique brand with a professional storefront for only ₦30,000 / $30 for the first year." />
        <meta name="keywords" content="create online store Nigeria, how to start ecommerce business, online store builder, ecommerce website Nigeria" />
      </Helmet>
