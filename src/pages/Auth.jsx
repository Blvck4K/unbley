...
export default function Auth() {
  ...
  return (
    <div style={s.page}>
      ...
      {/* Left Sidebar Layout */}
      <div style={s.sidebar} className="hidden lg:flex">
          ...
          <form onSubmit={(e) => { e.preventDefault(); window.location.href = '/dashboard'; }}>
            {authMode === 'signup' ? (
              <>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0 48px' }}>
                  <div style={s.inputGroup}>
                    ...
                    <input type="text" placeholder={userType === 'brand' ? 'e.g. Zizzy W3ars' : 'e.g. John Doe'} style={s.input} />
                  </div>
                  <div style={s.inputGroup}>
                    <label style={s.label}>EMAIL ADDRESS</label>
                    <input type="email" placeholder="johndoe@gmail.com" style={s.input} />
                  </div>
                  {userType === 'brand' && (
                    <>
                      <div style={s.inputGroup}>
                        <label style={s.label}>PHONE NUMBER</label>
                        <input type="tel" placeholder="+1 (000) 000-0000" style={s.input} />
                      </div>
                      <div style={s.inputGroup}>
                        <label style={s.label}>BRAND CATEGORY</label>
                        <input type="text" placeholder="Fashion, Digital, Home" style={s.input} />
                      </div>
                    </>
                  )}
                  <div style={s.inputGroup}>
                    ...
                    <div style={{ position: 'relative' }}>
                      <input type={showPassword ? 'text' : 'password'} placeholder="••••••••" style={s.input} />
                ...
                <button type="submit" style={s.button}>{userType === 'brand' ? 'JOIN AS BRAND OWNER' : 'CREATE ACCOUNT'}</button>
              ...
              <>
                ...
                <button type="submit" style={{ ...s.button, marginTop: '40px' }}>Welcome Back</button>
      ...
      <div className="hidden xl:flex" style={{ width: '400px', backgroundColor: '#070707', borderLeft: '1px solid #1F1F1F', padding: '80px', alignItems: 'center', justifyContent: 'center' }}>
