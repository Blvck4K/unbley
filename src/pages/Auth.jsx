          ...
          >
            ...
            <form onSubmit={handleAuth}>
              ...
              <div style={{ display: 'flex', gap: '16px' }} className="auth-google-apple">
                <button type="button" onClick={handleGoogleLogin} style={{ flex: 1, padding: '12px', backgroundColor: 'transparent', border: '1px solid #333', color: '#FFF', fontSize: '12px', fontWeight: '600', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', cursor: 'pointer', transition: 'all 0.2s' }}>
