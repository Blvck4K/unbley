...
import { Check, X, CreditCard, PiggyBank, Smile, ShieldCheck } from 'lucide-react';
...
export default function ShopifyAlternative() {
  ...
  return (
    <PageTransition>
      <Helmet>
        <title>Shopify Alternative in Nigeria & Global | Best Value Ecommerce | ZizzyStores</title>
        <meta name="description" content="Tired of paying Shopify in USD? ZizzyStores is the best Shopify alternative for Nigerian and global brand owners. Start at only ₦30,000 / $30 for a full year." />
        <meta name="keywords" content="Shopify alternative Nigeria, best ecommerce platform Nigeria, affordable shopify alternative, ecommerce for creators" />
      </Helmet>
      ...
      <main style={{ paddingTop: '80px' }}>
        {/* Comparison Hero */}
        <section style={{ padding: '60px 20px', backgroundColor: 'var(--bg-light)' }}>
        ...
        <section style={{ padding: '80px 20px' }}>
          <div className="container">
            <h2 style={{ textAlign: 'center', fontSize: '32px', fontWeight: '700', marginBottom: '48px' }}>See the Massive Difference</h2>
            <div style={{
